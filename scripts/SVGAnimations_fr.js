function initSVGAnimations(){
  illuminating = new TimelineMax({delay:0.5})
    ...
    .add([
      TweenMax.from(illuminating_svg_70b, 1.0, svg_draw_fade),
      TweenMax.from(illuminating_svg_70w, 1.0, svg_draw),
      TweenMax.from(illuminating_svg_71b, 1.0, svg_draw_fade),
      TweenMax.from(illuminating_svg_71w, 1.0, svg_draw),
      TweenMax.from(illuminating_svg_72b, 1.0, svg_draw_fade),
      TweenMax.from(illuminating_svg_72w, 1.0, svg_draw),
      TweenMax.from(illuminating_svg_73b, 0.5, svg_draw_fade),
      TweenMax.from(illuminating_svg_73w, 0.5, svg_draw),
      TweenMax.fromTo(illuminating_svg_74b, 1.5, svg_draw_fade_reverse_from, svg_draw_fade_reverse_to),
      TweenMax.fromTo(illuminating_svg_74w, 1.5, svg_draw_reverse_from, svg_draw_reverse_to)
    ], 0.9+0.2)
    .add([
  ...
  usge = new TimelineMax()
    ...
    .add([
      ...
      TweenMax.fromTo(usge_svg_22b, 1, svg_draw_fade_reverse_from, svg_draw_fade_reverse_to),
      TweenMax.fromTo(usge_svg_22w, 1, svg_draw_reverse_from, svg_draw_reverse_to),
    ], 0.15)
    .add([
      TweenMax.from(usge_svg_30b, 1, svg_draw_fade),
      TweenMax.from(usge_svg_30w, 1, svg_draw),
      TweenMax.from(usge_svg_31b, 1, svg_draw_fade),
      TweenMax.from(usge_svg_31w, 1, svg_draw)
    ], 0.3)
    .add([
  ...
  newheadline = new TimelineMax()
    .add([
      ...
      TweenMax.from(newheadline_svg_11b, 1, svg_draw_fade),
      TweenMax.from(newheadline_svg_11w, 1, svg_draw)
    ], 0.0)
    .add([
      TweenMax.from(newheadline_svg_20b, 1, svg_draw_fade),
      TweenMax.from(newheadline_svg_20w, 1, svg_draw),
      TweenMax.fromTo(newheadline_svg_21b, 1, svg_draw_fade_reverse_from, svg_draw_fade_reverse_to),
      TweenMax.fromTo(newheadline_svg_21w, 1, svg_draw_reverse_from, svg_draw_reverse_to)
    ], 0.15)
    .add([
    ...
    .add([
      ...
      TweenMax.fromTo(newheadline_svg_81b, 1, svg_draw_fade_reverse_from, svg_draw_fade_reverse_to),
      TweenMax.fromTo(newheadline_svg_81w, 1, svg_draw_reverse_from, svg_draw_reverse_to)
    ], 1.05)
    .add([
    ...
    .add([
      TweenMax.from(newheadline_svg_100b, 1, svg_draw_fade),
      TweenMax.from(newheadline_svg_100w, 1, svg_draw),
      TweenMax.from(newheadline_svg_101b, 1, svg_draw_fade),
      TweenMax.from(newheadline_svg_101w, 1, svg_draw)
    ], 1.35);
}